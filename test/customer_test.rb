...
class CustomerTest < Minitest::Test
  ...
  def test_it_returns_an_array_of_invoices
    customer = Customer.new(customer_repo.find_by_id(999), db)
  ...
  def test_invoices__it_returns_the_correct_invoices
    customer = Customer.new(customer_repo.find_by_id(21), db)
  ...
  def test_it_finds_all_transactions_by_the_customer
    customer = Customer.new(customer_repo.find_by_id(25), db)
